...
public class MvcArchitectureTest extends AbstractDispatcherServletTest {
    ...
    public void oldArchitecture() throws ServletException, IOException {
        ...
        assertThat(getBean(SimpleInterceptor.class).handler, instanceOf(SimpleController.class));
    }
    ...
    public void newArchitecture() throws ServletException, IOException {
        ...
        assertThat(getBean(SimpleInterceptor.class).handler, instanceOf(HandlerMethod.class));
    }
    ...
    @Test
    public void handlerMethodInterceptor() throws Exception {
